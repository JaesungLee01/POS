...
public class SalesProdVo {
	...
	public String toString() {
		return "SalesProdVo [SALES_DT=" + SALES_DT + ", SALES_SER_NO=" + SALES_SER_NO + ", SER_NO=" + SER_NO
				...
				+ SALES_AMT + ", SALE_AMT=" + SALE_AMT + ", TAX_TY=" + TAX_TY + ", TRANS_TY=" + TRANS_TY + ", MEMB_NO="
				+ MEMB_NO + ", getMEMB_NO()=" + getMEMB_NO() + ", getSALES_DT()=" + getSALES_DT()
				+ ", getSALES_SER_NO()=" + getSALES_SER_NO() + ", getSER_NO()=" + getSER_NO() + ", getPROD_CD()="
				+ getPROD_CD() + ", getQTY()=" + getQTY() + ", getSALES_PR()=" + getSALES_PR() + ", getVAT()="
				+ getVAT() + ", getSALES_AMT()=" + getSALES_AMT() + ", getSALE_AMT()=" + getSALE_AMT()
				+ ", getTAX_TY()=" + getTAX_TY() + ", getTRANS_TY()=" + getTRANS_TY() + ", getClass()=" + getClass()
